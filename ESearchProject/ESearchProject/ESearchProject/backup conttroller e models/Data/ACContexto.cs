...
*/
        protected override void OnModelCreating(ModelBuilder mb){
            ...
            mb.Entity<Evento>().ToTable("Markers");
            ...
            mb.Entity<Cliente>().ToTable("Cliente").HasOne<Contato>(ct => ct.Contato).WithOne(cli => cli.Cliente).HasForeignKey<Cliente>(cl => cl.IdContato);
